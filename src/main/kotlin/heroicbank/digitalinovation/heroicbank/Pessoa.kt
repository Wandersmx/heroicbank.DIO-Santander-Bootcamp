...
class Pessoa {
    ...
    //Cada dado em uma classe são membros.
    ...
    //Quando é chamada a função pessoa apos os dados serem inicializados o constructor é iniciilizado.
    constructor()
